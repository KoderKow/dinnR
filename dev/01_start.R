...
usethis::use_mit_license( name = "Kyle Harris" )  # You can set another license here
...
golem::use_favicon("/Users/Kow/Downloads/favicon_io/favicon.ico") # path = "path/to/ico". Can be an online file. 
